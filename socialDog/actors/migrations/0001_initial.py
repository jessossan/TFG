    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cif', models.CharField(help_text='Requerido. CIF para escuelas; Código de Centro para academías.', max_length=9, unique=True, validators=[django.core.validators.RegexValidator(message='El código de identificación debe estar compuesto de 8 dígitos o 9 dígitos.', regex='^(\\d{8,9})$')], verbose_name='CIF or Center Code')),
